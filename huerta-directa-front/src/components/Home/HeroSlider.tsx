      ...
      >
        {slides.map((slide, index) => (
          <SwiperSlide key={index}>
            <div className="relative h-150 w-full! flex items-center justify-center overflow-hidden">
              {/* Imagen */}
              <img
                src={slide.image}
                alt={slide.tag}
              ...
              {/* Contenido */}
              <div className="relative z-10 mr-100  max-w-120 bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-2xl">
                <h4 className="inline-block bg-[#8dc84b] text-white px-4 py-1 rounded-full text-sm mb-4">
                  {slide.tag}
                </h4>

                <h2 className="text-3xl font-normal text-[#8dc84b] leading-snug mb-5">
                  <span>{slide.title1}</span>
                  <br />
                  <strong className="text-4xl font-bold">{slide.title2}</strong>
                </h2>
