...
export const AboutSection = () => {
  ...
  return (
    <section className="bg-linear-to-b  from-[#FEF5DC] via-white to-[#FEF5DC]">
      <div className="bg-white max-w-350 mx-auto flex flex-col lg:flex-row items-start justify-center gap-10 mt-8 p-8 rounded-2xl">
        {/* LEFT SIDE */}
        <div className="text-left p-8 border border-gray-400/60 rounded-2xl flex-1">
          ...
          <h2 className="text-2xl font-semibold text-[#558b2f] mt-8 mb-2">
            Nuestra Misión
          </h2>
        ...
        {/* RIGHT SIDE */}
        <div className="border border-gray-400/60 rounded-2xl p-8 flex flex-col gap-16 flex-1">
          {/* COMMENT SECTION */}
          <article>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <textarea
                ...
                required
                className="w-full p-3 border border-gray-400 rounded-md resize-y focus:outline-none focus:ring-2 focus:ring-green-500"
              />
              ...
              <div className="flex items-center justify-between flex-wrap gap-3 text-sm">
                <label className="flex items-center gap-2">
                  ...
                  <span>
                    Acepto los{" "}
                    <a href="#" className="text-[#558b2f] hover:underline">
          ...
          {/* CTA SECTION */}
          <article className="bg-white p-8 rounded-lg shadow-sm text-center border-2 border-gray-300">
