...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onToggle }) => {
  ...
  return (
    <>
      ...
      <button
        className="fixed left-5 top-[100px] z-[1001] bg-[#8dc84b] text-white w-[45px] h-[45px] rounded-full flex items-center justify-center text-xl shadow-lg hover:scale-110 transition-all duration-300"
        onClick={onToggle}
      >
