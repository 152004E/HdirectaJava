    ...
    <div className="w-full mb-2">
      <div className="flex items-center min-w-[320px] relative">
        ...
        <input
          ...
          required={required}
          className="py-2.5 pl-10 pr-12 w-full my-1.5 border-2 border-[#8dc84b] rounded-[15px] outline-none text-base text-[#333128] transition-all duration-300 focus:border-[#004d00] focus:shadow-[0_0_8px_rgba(0,77,0,0.4)]"
        />
